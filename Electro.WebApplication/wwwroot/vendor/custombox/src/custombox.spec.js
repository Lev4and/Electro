...
describe('Custombox', () => {
    ...
    describe('Overlay', () => {
        ...
        it('should have put overlay color', (done) => {
            ...
            setTimeout(() => {
                ...
                let overlay = document.querySelector('.custombox-overlay');
    ...
    describe('Content', () => {
        ...
        it('should open from youtube with a specific size', (done) => {
            ...
            setTimeout(() => {
                let frame = document.querySelector('.custombox-content > div');
        ...
        it('should remove the property of display:none', (done) => {
            ...
            setTimeout(() => {
                let custom = document.querySelector('.custombox-content > div');
    ...
    describe('Loader', () => {
        ...
        it('should show loader', (done) => {
            ...
            setTimeout(() => {
                ...
                let loader = document.querySelector('.custombox-loader');
